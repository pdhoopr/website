  ...
  return (
    <section id="about">
      ...
      <Container>
        ...
        <div className="bio">
          <p>Ever since I was a little kid, I&apos;ve had an affinity for keeping things clean. I like when things are streamlined and seamless. I believe in quality over quantity and all that jazz. I even have a degree centered around optimization and efficiency. Nerdy, right? But now I get to use my education and love of web dev to create cool things every day! See <Link to={resume}>my résumé</Link> for more info.</p>
